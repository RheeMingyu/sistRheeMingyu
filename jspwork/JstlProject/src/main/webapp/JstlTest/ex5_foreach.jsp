...
<body>
	...
	<h3>list에는 총 ${totalCount }개의 색상이 들어있다</h3> <!-- requestScope생략가능..sessionScope도 생략가능이지만 구분위해 그냥쓴다 -->
	<h3>list에는 총 ${requestScope.totalCount }개의 색상이 들어있다</h3>
	<!-- 달러{변수명}일경우 앞에 requestScope가 생략된것임..request에 저장된 데이터는 자바처럼 getAttribute로 얻지않아도 바로출력 가능
		하지만 세션은 sessionScope를 샹략하지 않는다 -->
