	...
	<table class="table table-bordered" style="width: 800px;margin-left: 100px;">
		...
		<tr>
			...
			<td><input type="text" name="price" class="form-control"
					placeholder="가격입력" required="required"></td>
		</tr>
		<tr>
			<th width="120">색상</th>
			<td><input type="color" name="color" class="form-control" required="required"></td>
			<th width="120">입고일</th>
			<td><input type="date" name="ipgoday" class="form-control" required="required"></td>
		</tr>
		<tr>
			<td colspan="4">
