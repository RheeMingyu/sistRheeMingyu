...
<body>
	...
	<table style="width: 500px">
		<tr>
			...
			<td>
				<div class="box" style="background-color: ${dto.carcolor}"></div>${dto.carcolor }
			</td>
		</tr>
		<tr>
			<td>차종: ${dto.carname }</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<button type="button" class="btn btn-outline-info" onclick="location.href=''">등록</button>
				<button type="button" class="btn btn-outline-info" onclick="location.href=''">목록</button>
			</td>
		</tr>
	</table>
</body>
